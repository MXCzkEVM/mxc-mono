...
require (
	...
	github.com/mxczkevm/go-ethereum-arb v0.0.5
...
replace github.com/ethereum/go-ethereum v1.14.11 => github.com/MXCzkEVM/mxc-geth v1.11.1

replace github.com/ethereum-optimism/optimism v1.7.4 => github.com/taikoxyz/optimism v0.0.0-20241025022913-38db5117cd4c
